...
var _user$project$Portfolio$uniqueConcatMap = F2(
	function (projection, list) {
		return _elm_community$list_extra$List_Extra$unique(
			_elm_lang$core$List$concat(
				A2(_elm_lang$core$List$map, projection, list)));
	});
var _user$project$Portfolio$viewSelect = F4(
	function (labelText, onInputMessage, selectedValue, list) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onInput(onInputMessage),
							_elm_lang$html$Html_Attributes$value(selectedValue)
						]),
					A2(
						_elm_lang$core$List$map,
						function (str) {
						...
						A2(_elm_lang$core$List_ops['::'], 'All', list)))
				]));
	});
var _user$project$Portfolio$filterEntries = F2(
	function (_p0, entries) {
		var _p1 = _p0;
		var _p3 = _p1._1;
		var _p2 = _p1._0;
		return A2(
			...
			function (entry) {
				return A2(
					_elm_lang$core$List$any,
					function (str) {
						return _elm_lang$core$Native_Utils.eq(str, _p3) || _elm_lang$core$Native_Utils.eq(_p3, 'All');
					},
					entry.technologies) && A2(
					_elm_lang$core$List$any,
					function (str) {
						return _elm_lang$core$Native_Utils.eq(str, _p2) || _elm_lang$core$Native_Utils.eq(_p2, 'All');
					},
					entry.architecture);
			},
			entries);
	});
var _user$project$Portfolio$joinList = F2(
	function (sep, lst) {
		return A2(
			_elm_lang$core$String$dropLeft,
			_elm_lang$core$String$length(sep),
			A3(
				_elm_lang$core$List$foldl,
				F2(
					function (str, acc) {
						return A2(
							_elm_lang$core$Basics_ops['++'],
							acc,
							A2(_elm_lang$core$Basics_ops['++'], sep, str));
					}),
				'',
				lst));
	});
...
var _user$project$Portfolio$viewEntry = function (entry) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Portfolio$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'PortfolioRetrieved':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{portfolioEntries: _p4._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PortfolioRetrievalError':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var _p6 = _p4._1;
				var _p5 = _p4._0;
				if (_p5.ctor === 'ArchitectureFilter') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: {ctor: '_Tuple2', _0: _p6, _1: 'All'}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: {ctor: '_Tuple2', _0: 'All', _1: _p6}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Portfolio$entryDecoder = A7(
	_elm_lang$core$Json_Decode$object6,
	F6(
		function (title, picture, architecture, technologies, link, description) {
			return {title: title, picture: picture, architecture: architecture, technologies: technologies, link: link, description: description};
		}),
...
var _user$project$Portfolio$portfolioDecoder = _elm_lang$core$Json_Decode$list(_user$project$Portfolio$entryDecoder);
var _user$project$Portfolio$PortfolioEntry = F6(
	function (a, b, c, d, e, f) {
		return {title: a, picture: b, architecture: c, technologies: d, link: e, description: f};
	});
var _user$project$Portfolio$Model = F2(
	function (a, b) {
		return {portfolioEntries: a, filter: b};
	});
var _user$project$Portfolio$TechnologyFilter = {ctor: 'TechnologyFilter'};
var _user$project$Portfolio$ArchitectureFilter = {ctor: 'ArchitectureFilter'};
var _user$project$Portfolio$FilterChanged = F2(
	function (a, b) {
		return {ctor: 'FilterChanged', _0: a, _1: b};
	});
var _user$project$Portfolio$viewFilters = function (_p7) {
	var _p8 = _p7;
	var _p10 = _p8;
	var _p9 = _p8.filter;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A4(
				_user$project$Portfolio$viewSelect,
				'Architecture',
				_user$project$Portfolio$FilterChanged(_user$project$Portfolio$ArchitectureFilter),
				_elm_lang$core$Basics$fst(_p9),
				A2(
					_user$project$Portfolio$uniqueConcatMap,
					function (entry) {
						return entry.architecture;
					},
					_p10.portfolioEntries)),
				A4(
				_user$project$Portfolio$viewSelect,
				'Technology',
				_user$project$Portfolio$FilterChanged(_user$project$Portfolio$TechnologyFilter),
...
var _user$project$Portfolio$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Portfolio$viewFilters(model)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-md-10')
							]),
						A2(
							_elm_lang$core$List$map,
							_user$project$Portfolio$viewEntry,
							A2(_user$project$Portfolio$filterEntries, model.filter, model.portfolioEntries)))
					]))
			]));
};
var _user$project$Portfolio$PortfolioRetrievalError = function (a) {
	return {ctor: 'PortfolioRetrievalError', _0: a};
};
var _user$project$Portfolio$PortfolioRetrieved = function (a) {
	return {ctor: 'PortfolioRetrieved', _0: a};
};
var _user$project$Portfolio$init = {
	ctor: '_Tuple2',
	_0: {
		portfolioEntries: _elm_lang$core$Native_List.fromArray(
			[]),
		filter: {ctor: '_Tuple2', _0: 'All', _1: 'All'}
	},
	_1: A3(
		_elm_lang$core$Task$perform,
		_user$project$Portfolio$PortfolioRetrievalError,
		_user$project$Portfolio$PortfolioRetrieved,
		A2(_evancz$elm_http$Http$get, _user$project$Portfolio$portfolioDecoder, 'portfolio.json'))
};
var _user$project$Portfolio$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$Portfolio$init,
			view: _user$project$Portfolio$view,
			update: _user$project$Portfolio$update,
...
var Elm = {};
Elm['Portfolio'] = Elm['Portfolio'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Portfolio'], 'Portfolio', typeof _user$project$Portfolio$main === 'undefined' ? null : _user$project$Portfolio$main);
